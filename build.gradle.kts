...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-forge", version = "0.8.1-dust.0")
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-remapper", version = "0.7.1-dust.0")
