...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-forge", version = "0.7.4-dust.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-fabric", version = "0.6.11-dust.0")
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-access-widener", version = "0.6.0-dust.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-remapper", version = "0.6.8-dust.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-decompiler", version = "0.6.0")
    implementation(group = "net.msrandom", name = "minecraft-codev-includes", version = "0.6.5-dust")
    ...
    implementation(group = "net.msrandom", name = "classpath-api-stubs", version = "0.1.12-dust")
