...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-access-widener", version = "0.6.3-dust.1")
    ...
    implementation(group = "net.msrandom", name = "classpath-api-stubs", version = "0.1.12-dust.1")
