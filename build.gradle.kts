...
dependencies {
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-forge", version = "0.8.4-dust.1")
    ...
    implementation(group = "net.msrandom", name = "minecraft-codev-access-widener", version = "0.6.3-dust.3")
    implementation(group = "net.msrandom", name = "minecraft-codev-remapper", version = "0.7.1-dust.2")
    implementation(group = "net.msrandom", name = "minecraft-codev-decompiler", version = "0.6.0-dust.1")
    ...
    implementation(group = "net.msrandom", name = "classpath-api-stubs", version = "0.1.12-dust.4")
